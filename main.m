...
for i = 1:length(L_1)
	for j = 1:length(Pout_Psg_ratio)
		...
		g_0(j) = g_0_function(r_1, r_2, alpha_s, L_1(i), alpha_2l, L_2, alpha_1l, L, Pout_Psg_ratio(j), Beta);
        g_0L(j) = g_0(j) .* L;
	end
    plot(g_0L, Pout_Psg_ratio,'LineWidth', 2)
    hold on
...
legend('L_1 = 2cm', 'L_1 = 3cm','L_1 = 5cm','L_1 = 7cm')
str_for_title_1 = 'Wykres 5';
str_for_title_2 = 'Zmiana parametru L_1';
str_for_title_3 = '\beta=5';
str_for_title_4 = "\alpha_{s}=1/L_2";
str_for_title_5 = "\alpha_{l2}=0.1/L_{2}";
str_for_title_6 = "\alpha_{l1}=0.1/L_1";
str_for_title_7 = "r_2=0.9";
title({str_for_title_1;
    str_for_title_2;
    str_for_title_3;
    str_for_title_4;
